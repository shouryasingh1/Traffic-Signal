...
public class traffic extends Applet implements Runnable
{
    ...
    public void init()
        ...
        f=new Font("Comic Sans MS",f.ITALIC,28);
        f1=new Font("Comic Sans MS",Font.ITALIC+Font.BOLD,28);
    ...
    public void paint(Graphics g)
    {
        ...
        g.setColor(Color.black);
        g.setFont(f1);
        g.drawString ("Rolls Royce",350,200);
